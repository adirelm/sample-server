...
exports.sendMailToAdminWelcome = exports.sendMailToAdminStatusChanged = void 0;
...
const sendMailToAdminWelcome = function (serverName, serverUrl, adminMail) {
    mail_1.default.send({
        to: adminMail,
        from: "adir@monkeytech.co.il",
        subject: "The health status of your server is changed!",
        html: adminWelcomeEmailTemplate(serverName, serverUrl, adminMail),
    });
};
exports.sendMailToAdminWelcome = sendMailToAdminWelcome;
const adminWelcomeEmailTemplate = function (server_name, server_url, admin_mail) {
    return `    <body>
...
<tbody>
  <tr>
    <td style="padding:18px 0px 18px 0px; line-height:22px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="font-size: 18px"><strong>Welcome!<br>
You have successfully registered to Sample Server Service.<br>
...
<tbody>
  <tr>
    <td style="padding:18px 0px 18px 0px; line-height:22px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="color: #000000; font-family: arial, helvetica, sans-serif; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: left; text-indent: 0px; text-transform: none; white-space: pre-wrap; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: rgb(255, 255, 255); text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial; float: none; display: inline; font-size: 16px">Your server will receive a sample every 2 minutes, we will notify you if access to your server is limited.<br>
<br>
