...
exports.sendMailToAdmin = void 0;
const mail_1 = __importDefault(require("@sendgrid/mail"));
mail_1.default.setApiKey(process.env.SENDGRID_APIKEY);
const sendMailToAdmin = function (serverName, serverUrl, serverStatus, adminMail) {
    mail_1.default.send({
        to: adminMail,
...
const emailTemplate = function (server_name, server_url, server_status) {
    return `
  <body>
