...
exports.sendMailUserWelcome = exports.sendMailAdminServerRegister = exports.sendMailToAdminStatusChanged = void 0;
...
const sendMailUserWelcome = function (username, firstname, adminMail) {
    mail_1.default.send({
        to: adminMail,
        from: "adir@monkeytech.co.il",
...
const userWelcomeEmailTemplate = function (username, firstname) {
    return `    <body>
